...
<html lang="pt-br">
  <head>
    ...
    <title>HouseFest | Cadastrar Administrador</title>
  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>Formulario para se cadastrar como administrador</h2>
        <p class="lead">`Prencha para se cadastrar como Administrador</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form  class="needs-validation" novalidate action="cadastrandoAdmin.php" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input name="senha" type="text" class="form-control" id="sobrenome" placeholder="" value="" required>
                <div class="invalid-feedback">
                  É obrigatório inserir uma Senha valida.
                </div>
              </div>
            ...
            <hr class="mb-4">
            <button class="btn btn-dark btn-lg btn-block" type="submit">Cadastrar Administrador</button>
          </form>
        </div>
      </div>
