...
<html lang="pt-br">
  <head>
    ...
    <title>HouseFest | Remover Evento</title>
  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>Formulario para remover um Evento</h2>
        <p class="lead">`Prencha para remover o seu evento</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate action="remover.php" method="POST">
            ...
            <hr class="mb-4">
            <button class="btn btn-dark btn-lg btn-block" type="submit">Remover Evento </button>
          </form>
        </div>
      </div>
